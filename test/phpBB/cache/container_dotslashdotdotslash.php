...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['console.command.cron.list'] = new \phpbb\console\command\cron\cron_list($this->get('cron.manager'), $this->get('user'));
    }
    ...
    {
        return $this->services['console.command.cron.run'] = new \phpbb\console\command\cron\run($this->get('cron.manager'), $this->get('cron.lock_db'), $this->get('user'));
    }
    ...
    {
        return $this->services['console.command.dev.migration_tips'] = new \phpbb\console\command\dev\migration_tips($this->get('ext.manager'));
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), $this->get('symfony_request'), './../', 'php');
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'test', 'mj685187', 'phpbb_test', '', false, false);
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), './../', 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => '',
            'dbal.dbuser' => 'test',
            'dbal.dbpasswd' => 'mj685187',
            'dbal.dbname' => 'phpbb_test',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
