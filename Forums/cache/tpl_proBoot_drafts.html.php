...
<div class="panel row-fluid">
	...
	<h3 class="box-heading"><?php echo ((isset($this->_rootref['L_LOAD_DRAFT'])) ? $this->_rootref['L_LOAD_DRAFT'] : ((isset($user->lang['LOAD_DRAFT'])) ? $user->lang['LOAD_DRAFT'] : '{ LOAD_DRAFT }')); ?></h3>
...
<div class="row-fluid <?php if (! $this->_rootref['S_PRIVMSGS']) {  ?>forumbg<?php } else { ?>panel<?php } ?>">
	<div class="well">
