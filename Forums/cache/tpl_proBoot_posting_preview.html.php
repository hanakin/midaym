<?php if (!defined('IN_PHPBB')) exit; ?><div class="row-fluid" id="preview">
	<div class="well">
...
<?php } ?>
		...
		<h3 class="box-heading"><?php echo ((isset($this->_rootref['L_PREVIEW'])) ? $this->_rootref['L_PREVIEW'] : ((isset($user->lang['PREVIEW'])) ? $user->lang['PREVIEW'] : '{ PREVIEW }')); ?></h3>

		<div class="content">
		<h3><?php echo (isset($this->_rootref['PREVIEW_SUBJECT'])) ? $this->_rootref['PREVIEW_SUBJECT'] : ''; ?></h3>
		<p><?php echo (isset($this->_rootref['PREVIEW_MESSAGE'])) ? $this->_rootref['PREVIEW_MESSAGE'] : ''; ?></p></div>
