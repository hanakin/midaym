...
<div id="login-content" class="grid_24">
	<form action="<?php echo (isset($this->_rootref['S_LOGIN_ACTION'])) ? $this->_rootref['S_LOGIN_ACTION'] : ''; ?>" method="post" id="login" class="clearfix">
		<div class="panel grid_24">
		...
		<div class="panel grid_24">
			<div class="inner">
				...
				<span class="button2"><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></span>
			</div>
		</div>
		<?php } ?>
