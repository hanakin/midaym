<?php if (!defined('IN_PHPBB')) exit; ?><div class="row-fluid no-margin" id="poll-panel">
	<div class="well">
	...
	<?php if ($this->_rootref['S_SHOW_POLL_BOX']) {  if ($this->_rootref['S_POLL_DELETE']) {  ?>
		...
		<dl>
			...
			<dd><div class="input-append"><input type="text" name="poll_length" id="poll_length" size="3" maxlength="3" value="<?php echo (isset($this->_rootref['POLL_LENGTH'])) ? $this->_rootref['POLL_LENGTH'] : ''; ?>" class="input-mini" /><span class="add-on"><?php echo ((isset($this->_rootref['L_DAYS'])) ? $this->_rootref['L_DAYS'] : ((isset($user->lang['DAYS'])) ? $user->lang['DAYS'] : '{ DAYS }')); ?></span></div></dd>
